...
class Lab7GroupProject(tk.Tk):
    def __init__(self):
        ...
        # Create a button to optionally save the results to a file with a filename specified in a box on a pop up
        # window.
        ...
        # "the" and n is 0, add "the" to your internal list; if the search term entered is "the" and n is 1, add
        # "Senate" to your internal list; if the search term entered is "the" and n is 2, add "has" to your
        # internal list, etcetera.
