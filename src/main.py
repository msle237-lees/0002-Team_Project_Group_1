...
class Lab7GroupProject(tk.Tk):
    def __init__(self):
        ...
        self.case_sensitive_checkbox.grid(row=3, column=1, padx=15, pady=15, columnspan=1, sticky="ew")
        ...
        self.total_matches_label.grid(row=4, column=0, padx=15, pady=15, columnspan=1, sticky="ew")
        ...
        self.total_matches_label.grid(row=4, column=3, padx=15, pady=15, columnspan=1, sticky="ew")
